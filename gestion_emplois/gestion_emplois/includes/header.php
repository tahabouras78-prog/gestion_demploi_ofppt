    ...
    <div class="row">
        <nav class="col-md-3 col-lg-2 d-md-block sidebar py-4">
            ...
            <ul class="nav flex-column px-2">
                ...
                <li class="nav-item mt-4 pt-3 border-top border-secondary"><a class="nav-link text-danger fw-bold" href="../logout.php"><i class="bi bi-box-arrow-left me-2"></i> Déconnexion</a></li>                                                                      
                <li class="nav-item"> <a class="nav-link <?= $current_page == 'profil.php' ? 'active' : '' ?>" href="profil.php"><i class="bi bi-person-gear me-2"></i> Mon Profil</a></li><li class="nav-item mt-4 pt-3 border-top border-secondary">                                      
            </ul>
        </nav>
